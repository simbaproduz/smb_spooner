...
Config.DevAllowAllPermissions = true
...
if Config.isRDR then
	...
	Config.SpawnControl           = `INPUT_CONTEXT_Y` -- E (KEY_E confirmado no default.meta local)
	...
	Config.FreezeToggleControl    = `INPUT_SELECT_QUICKSELECT_HANDGUN` -- 2
else
...
-- Auto-save grava apenas em caminho relativo seguro dentro da resource.
Config.AutoSaveBaseDirectory = 'exports/autosave'
Config.AutoSaveMaxBytes = 1024 * 1024 * 4
Config.AutoSaveCooldownMs = 2000

-- Limites defensivos para salvar propsets custom sem abrir superficie demais.
Config.CustomPropsetMaxItems = 500
Config.CustomPropsetMaxBytes = 1024 * 1024 * 2
Config.CustomPropsetCooldownMs = 1500
